...
class DateTimeUtilsSuite extends SparkFunSuite {
  ...
  test("from UTC timestamp") {
    ...
    def testDST(utc: SQLTimestamp, tz: String, expected: SQLTimestamp): Unit = {
      assert(fromUTCTime(utc, tz) === expected)
    }
    // "2016-03-13 09:59:59.0 UTC" == "2016-03-13 01:59:59.0 PST"
    testDST(1457888399000000L, "PST", 1457863199000000L)
    // "2016-03-13 10:00:00.0 UTC" == "2016-03-13 03:00:00.0 PST"
    testDST(1457888400000000L, "PST", 1457863200000000L)
    // "2016-11-06 08:59:59.0 UTC" == "2016-11-06 01:59:59.0 PST"
    testDST(1478451599000000L, "PST", 1478422799000000L)
    // "2016-11-06 09:00:00.0 UTC" == "2016-11-06 01:00:00.0 PST"
    testDST(1478451600000000L, "PST", 1478422800000000L)
    // "2016-11-06 10:00:00.0 UTC" == "2016-11-06 02:00:00.0 PST"
    testDST(1478455200000000L, "PST", 1478426400000000L)
  }
  ...
  test("to UTC timestamp") {
    ...
    // Daylight Saving Time
    def testDST(utc: SQLTimestamp, tz: String, expected: SQLTimestamp): Unit = {
      assert(toUTCTime(utc, tz) === expected)
    }
    // "2016-03-13 01:59:59 PST" == "2016-03-13 09:59:59.0 UTC"
    testDST(1457863199000000L, "PST", 1457888399000000L)
    // 2016-03-13 02:00:00 PST does not exists
    // "2016-03-13 03:00:00 PST" == "2016-03-13 10:00:00.0 UTC"
    testDST(1457863200000000L, "PST", 1457888400000000L)
    // "2016-11-06 00:59:59 PST" == "2016-11-06 07:59:59.0 UTC"
    testDST(1478419199000000L, "PST", 1478447999000000L)
    // 2016-11-06 01:00:00 PST could be 2016-11-06 08:00:00 UTC or 2016-11-06 09:00:00 UTC
    // "2016-11-06 01:00:00 PST" == "2016-11-06 09:00:00.0 UTC"
    testDST(1478422800000000L, "PST", 1478451600000000L)
    // "2016-11-06 01:59:59 PST" == "2016-11-06 09:59:59.0 UTC"
    testDST(1478426399000000L, "PST", 1478455199000000L)
    // "2016-11-06 02:00:00 PST" == "2016-11-06 10:00:00.0 UTC"
    testDST(1478426400000000L, "PST", 1478455200000000L)
  }
